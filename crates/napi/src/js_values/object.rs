...
impl TryFrom<sys::napi_key_collection_mode> for KeyCollectionMode {
  ...
  fn try_from(value: sys::napi_key_collection_mode) -> Result<Self> {
    match value {
      sys::KeyCollectionMode::napi_key_include_prototypes => Ok(Self::IncludePrototypes),
      sys::KeyCollectionMode::napi_key_own_only => Ok(Self::OwnOnly),
      _ => Err(Error::new(
        crate::Status::InvalidArg,
        "Invalid key collection mode".to_owned(),
      )),
    }
  }
}
...
impl From<KeyCollectionMode> for sys::napi_key_collection_mode {
  fn from(value: KeyCollectionMode) -> Self {
    match value {
      KeyCollectionMode::IncludePrototypes => sys::KeyCollectionMode::napi_key_include_prototypes,
      KeyCollectionMode::OwnOnly => sys::KeyCollectionMode::napi_key_own_only,
    }
  }
}
...
impl TryFrom<sys::napi_key_filter> for KeyFilter {
  ...
  fn try_from(value: sys::napi_key_filter) -> Result<Self> {
    match value {
      sys::KeyFilter::napi_key_all_properties => Ok(Self::AllProperties),
      sys::KeyFilter::napi_key_writable => Ok(Self::Writable),
      sys::KeyFilter::napi_key_enumerable => Ok(Self::Enumerable),
      sys::KeyFilter::napi_key_configurable => Ok(Self::Configurable),
      sys::KeyFilter::napi_key_skip_strings => Ok(Self::SkipStrings),
      sys::KeyFilter::napi_key_skip_symbols => Ok(Self::SkipSymbols),
      _ => Err(Error::new(
        crate::Status::InvalidArg,
        "Invalid key filter".to_owned(),
      )),
    }
  }
}
...
impl From<KeyFilter> for sys::napi_key_filter {
  fn from(value: KeyFilter) -> Self {
    match value {
      KeyFilter::AllProperties => sys::KeyFilter::napi_key_all_properties,
      KeyFilter::Writable => sys::KeyFilter::napi_key_writable,
      KeyFilter::Enumerable => sys::KeyFilter::napi_key_enumerable,
      KeyFilter::Configurable => sys::KeyFilter::napi_key_configurable,
      KeyFilter::SkipStrings => sys::KeyFilter::napi_key_skip_strings,
      KeyFilter::SkipSymbols => sys::KeyFilter::napi_key_skip_symbols,
    }
  }
}
...
impl TryFrom<sys::napi_key_conversion> for KeyConversion {
  ...
  fn try_from(value: sys::napi_key_conversion) -> Result<Self> {
    match value {
      sys::KeyConversion::napi_key_keep_numbers => Ok(Self::KeepNumbers),
      sys::KeyConversion::napi_key_numbers_to_strings => Ok(Self::NumbersToStrings),
      _ => Err(Error::new(
        crate::Status::InvalidArg,
        "Invalid key conversion".to_owned(),
      )),
    }
  }
}
...
impl From<KeyConversion> for sys::napi_key_conversion {
  fn from(value: KeyConversion) -> Self {
    match value {
      KeyConversion::KeepNumbers => sys::KeyConversion::napi_key_keep_numbers,
      KeyConversion::NumbersToStrings => sys::KeyConversion::napi_key_numbers_to_strings,
    }
  }
}
