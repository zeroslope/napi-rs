...
pub type napi_property_attributes = ::std::os::raw::c_int;
...
pub type napi_valuetype = ::std::os::raw::c_int;
...
pub type napi_typedarray_type = ::std::os::raw::c_int;
...
pub type napi_status = ::std::os::raw::c_int;
...
fn bindgen_test_layout_napi_extended_error_info() {
  ...
  assert_eq!(
    unsafe {
      &(*(::std::ptr::null::<napi_extended_error_info>())).engine_reserved as *const _ as usize
    },
    4usize,
    concat!(
      "Offset of field: ",
  ...
  assert_eq!(
    unsafe {
      &(*(::std::ptr::null::<napi_extended_error_info>())).engine_error_code as *const _ as usize
    },
    8usize,
    concat!(
      "Offset of field: ",
...
pub type napi_key_collection_mode = ::std::os::raw::c_int;
...
pub type napi_key_filter = ::std::os::raw::c_int;
...
pub type napi_key_conversion = ::std::os::raw::c_int;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
fn bindgen_test_layout_napi_type_tag() {
  ...
  assert_eq!(
    unsafe { &(*(::std::ptr::null::<napi_type_tag>())).lower as *const _ as usize },
    0usize,
    concat!(
      "Offset of field: ",
  ...
  assert_eq!(
    unsafe { &(*(::std::ptr::null::<napi_type_tag>())).upper as *const _ as usize },
    8usize,
    concat!(
      "Offset of field: ",
      stringify!(napi_type_tag),
...
pub type napi_threadsafe_function_release_mode = ::std::os::raw::c_int;
...
pub type napi_threadsafe_function_call_mode = ::std::os::raw::c_int;
